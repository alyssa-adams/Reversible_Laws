...
NotebookDataLength[     77426,       1544]
NotebookOptionsPosition[     50174,        957]
NotebookOutlinePosition[     76445,       1518]
CellTagsIndexPosition[     76334,       1512]
WindowTitle->Cellular Automaton State Transition Diagrams
WindowFrame->Normal*)
...
Cell["Cellular Automaton State Transition Diagrams", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`icon$$ = False, $CellContext`label$$ = 
    If[$CellContext`w$$ < 7, True, False], $CellContext`rn$$ = 
    110, $CellContext`w$$ = 5, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`rn$$], 110, "rule number"}, 0, 255, 1}, {{
       Hold[$CellContext`w$$], 5, "width"}, 3, 12, 1}, {{
       Hold[$CellContext`label$$], 
       If[$CellContext`w$$ < 7, True, False], "show states"}, {
      True, False}}, {{
       Hold[$CellContext`icon$$], False, "show rule icon"}, {True, False}}}, 
    Typeset`size$$ = {500., {185., 190.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`rn$5109$$ = 0, $CellContext`w$5110$$ = 
    0, $CellContext`label$5111$$ = False, $CellContext`icon$5112$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`icon$$ = False, $CellContext`label$$ = 
        If[$CellContext`w$$ < 7, True, False], $CellContext`rn$$ = 
        110, $CellContext`w$$ = 5}, "ControllerVariables" :> {
        Hold[$CellContext`rn$$, $CellContext`rn$5109$$, 0], 
        Hold[$CellContext`w$$, $CellContext`w$5110$$, 0], 
        Hold[$CellContext`label$$, $CellContext`label$5111$$, False], 
        Hold[$CellContext`icon$$, $CellContext`icon$5112$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> (If[$CellContext`icon$$, 
        Labeled[#, 
         Grid[{
           Map[Column[
             Map[
             ArrayPlot[{#}, Mesh -> True, Frame -> False, ImageSize -> 
               8 Length[#]]& , #], Center, Spacings -> 0.025]& , 
            Thread[{
              Tuples[{1, 0}, 3], 
              Map[List, 
               IntegerDigits[$CellContext`rn$$, 2, 8]]}]]}, Frame -> All, 
          FrameStyle -> GrayLevel[1/GoldenRatio]]], #]& )[
        GraphPlot[
         Map[# -> CellularAutomaton[$CellContext`rn$$, #]& , 
          Tuples[{1, 0}, $CellContext`w$$]], ImageSize -> {500, 375}, 
         VertexRenderingFunction -> (With[{$CellContext`p$ = {
              Darker[Blue, 0.7], 
              Point[#]}}, 
           If[
            Not[$CellContext`label$$], $CellContext`p$, 
            If[$CellContext`w$$ < 7, 
             Inset[
              ArrayPlot[{#2}, Mesh -> True, Frame -> False, ImageSize -> 7 {
                  Length[#2], 1}], #], 
             Tooltip[$CellContext`p$, 
              Dynamic[
               ArrayPlot[{#2}, Mesh -> True, Frame -> False, ImageSize -> 7 {
                   Length[#2], 1}]]]]]]& ), DirectedEdges -> True]], 
      "Specifications" :> {{{$CellContext`rn$$, 110, "rule number"}, 0, 255, 
         1, Appearance -> "Labeled"}, {{$CellContext`w$$, 5, "width"}, 3, 12, 
         1, Appearance -> "Labeled"}, Delimiter, {{$CellContext`label$$, 
          If[$CellContext`w$$ < 7, True, False], "show states"}, {
         True, False}}, {{$CellContext`icon$$, False, "show rule icon"}, {
         True, False}}}, 
      "Options" :> {
       ControllerLinking -> True, AutorunSequencing -> {{1, 20}, {3, 5}}}, 
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"2", 
    StyleBox["^",
     FontSlant->"Italic"], "n"}], TraditionalForm]], "InlineMath"],
 " states of a size-",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 " elementary cellular automaton, and is joined to the vertex representing \
the state reached after one step in the cellular automaton evolution."
}], "ManipulateCaption",
 CellID->875702027],
...
Cell[TextData[{
 "A system of limited size has a behavior that is ultimately repetitive. The \
maximum possible repetition period for any system is always equal to the \
total number of possible states of the system. Of the elementary rules, only \
rule 45 seems to yield periods that always stay close to the maximum of ",
 Cell[BoxData[
  FormBox[
   RowBox[{
...
Cell[TextData[{
 ButtonBox["State Networks for Systems of Limited Size",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://wolframscience.com/nksonline/page-961d-text"], None}],
 " (",
 StyleBox[ButtonBox["NKS|Online",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://www.wolframscience.com/nksonline/"], None},
  ButtonNote->"http://www.wolframscience.com/nksonline/"],
  FontSlant->"Italic"],
 ")"
}], "RelatedLinks",
 CellID->307878655],
...
Cell[TextData[{
 ButtonBox["Systems of Limited Size and Class 2 Behavior",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.wolframscience.com/nksonline/page-255-text"], None}],
 " (",
 StyleBox[ButtonBox["NKS|Online",
  BaseStyle->"SiteLink",
  ButtonData->{
...
CellularAutomatonStateTransitionDiagrams&version=0036"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
CellularAutomatonStateTransitionDiagrams/\
CellularAutomatonStateTransitionDiagrams-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Cellular Automaton State Transition Diagrams",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
CellularAutomatonStateTransitionDiagrams/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
CellularAutomatonStateTransitionDiagrams/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39490, 692, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39751, 701, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49352, 932, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76048, 1501},
 {"Copyright", 76243, 1506}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[608, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34939, 590, 85, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[35027, 593, 3928, 79, 70, "Output",
 CellID->1655564525],
Cell[38958, 674, 476, 13, 70, "ManipulateCaption",
 CellID->875702027],
Cell[39437, 689, 50, 1, 70, "ManipulateCaption",
 CellID->1754549913],
Cell[39490, 692, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39751, 701, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41679, 747, 33, 0, 70, "DetailsSection"],
Cell[41715, 749, 471, 10, 70, "DetailNotes",
 CellID->1511972894],
Cell[42189, 761, 44, 0, 70, "RelatedLinksSection"],
Cell[42236, 763, 455, 14, 70, "RelatedLinks",
 CellID->307878655],
Cell[42694, 779, 460, 14, 70, "RelatedLinks",
 CellID->130768284],
Cell[43157, 795, 4863, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48023, 888, 45, 0, 70, "CitationSection"],
Cell[48071, 890, 925, 27, 70, "Citations"],
Cell[48999, 919, 350, 11, 70, "Author",
 CellID->394234764],
Cell[49352, 932, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature ATqVDd0M05govx7VIrqbMrxP *)
